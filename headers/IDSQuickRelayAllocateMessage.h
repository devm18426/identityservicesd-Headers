...
@property (copy) NSString * reportingDataBlob;                    //@synthesize reportingDataBlob=_reportingDataBlob - In the implementation block
@property (copy) NSArray * pluginRequests;                        //@synthesize pluginRequests=_pluginRequests - In the implementation block
...
@property (copy) NSArray * pluginAllocations;                     //@synthesize pluginAllocations=_pluginAllocations - In the implementation block
...
-(void)setPluginAllocations:(NSArray *)arg1 ;
-(unsigned long long)_recipientDataSize;
-(void)setReportingDataBlob:(NSString *)arg1 ;
@end
