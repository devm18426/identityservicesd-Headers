...
@property (assign,nonatomic) char serviceAllowLiveMessageDelivery;                            //@synthesize serviceAllowLiveMessageDelivery=_serviceAllowLiveMessageDelivery - In the implementation block
...
@property (assign,nonatomic) char serviceWantsTinkerDevices;                                  //@synthesize serviceWantsTinkerDevices=_serviceWantsTinkerDevices - In the implementation block
...
@property (assign,nonatomic) char shouldAllowLiveMessageDelivery;                             //@synthesize shouldAllowLiveMessageDelivery=_shouldAllowLiveMessageDelivery - In the implementation block
...
-(char)shouldAllowLiveMessageDelivery;
...
-(char)serviceAllowLiveMessageDelivery;
-(void)setServiceAllowLiveMessageDelivery:(char)arg1 ;
-(char)serviceUseiMessageCallerID;
-(void)setServiceUseiMessageCallerID:(char)arg1 ;
-(char)serviceWantsTinkerDevices;
-(void)setServiceWantsTinkerDevices:(char)arg1 ;
...
-(void)setShouldAllowLiveMessageDelivery:(char)arg1 ;
