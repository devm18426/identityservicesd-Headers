...
-(id)initWithBroadcastBlock:(/*^block*/id)arg1 needsClientAck:(char)arg2 messageUUID:(id)arg3 priority:(long long)arg4 senderID:(id)arg5 sequenceNumber:(unsigned)arg6 ;
