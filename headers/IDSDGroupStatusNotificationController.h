...
-(void)updateParticipantDataToMembers:(id)arg1 toGroup:(id)arg2 withContext:(id)arg3 params:(id)arg4 fromAccount:(id)arg5 fromID:(id)arg6 sessionID:(id)arg7 ;
...
-(void)_sendFanoutMessage:(id)arg1 account:(id)arg2 toGroupMembers:(id)arg3 fromID:(id)arg4 command:(long long)arg5 commandContext:(id)arg6 toGroup:(id)arg7 sessionID:(id)arg8 reason:(unsigned char)arg9 waitForMadridAcks:(char)arg10 completionBlock:(/*^block*/id)arg11 ;
