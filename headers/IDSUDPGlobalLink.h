...
-(void)_forwardPacketBuffer:(SCD_Struct_ID13*)arg1 fromDeviceUniqueID:(id)arg2 cbuuid:(id)arg3 ;
...
-(char)_processStunEchoRequest:(id)arg1 fromDevice:(id)arg2 localIfIndex:(unsigned)arg3 localAddress:(sockaddr*)arg4 remmoteAddress:(sockaddr*)arg5 arrivalTime:(double)arg6 ;
-(char)_processStunEchoResponse:(id)arg1 fromDevice:(id)arg2 localIfIndex:(unsigned)arg3 localAddress:(sockaddr*)arg4 remmoteAddress:(sockaddr*)arg5 arrivalTime:(double)arg6 ;
-(char)_processStunDataIndication:(id)arg1 fromDevice:(id)arg2 localIfIndex:(unsigned)arg3 localAddress:(sockaddr*)arg4 remmoteAddress:(sockaddr*)arg5 arrivalTime:(double)arg6 packetBuffer:(SCD_Struct_ID13*)arg7 fromDeviceUniqueID:(id)arg8 cbuuid:(id)arg9 ;
-(char)_processStunPacket:(SCD_Struct_ID13*)arg1 fromDevice:(id)arg2 arrivalTime:(double)arg3 fromDeviceUniqueID:(id)arg4 cbuuid:(id)arg5 ;
